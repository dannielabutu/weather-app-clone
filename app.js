// declaring our variable and fetching the api key for weather
let weather = {
...
displayWeather: function (data) {
    ...
    // using DOM to change the HTML from static to dynamic 
...
//assiging the search bar with the api to get the weather of the location entered
search: function () {
...
weather.fetchWeather("Greater Kano");
